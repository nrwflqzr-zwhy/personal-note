...
​	是为开发企业环境下的应用程序提供的一套解决方案。该技术体系中包含的技术如:Servlet 、Jsp等，主要针对于 Web 应用程序开发。版本以前称为 J2EE
...
<img src="Java%E5%9F%BA%E7%A1%80.images/image-20220630150615339-170313058631513.png" alt="image-20220701110025818" style="zoom:67%;" />
...
<img src="Java%E5%9F%BA%E7%A1%80.images/image-20220701110025818-170313059075816.png" alt="image-20220630150615339" style="zoom:67%;" />
...
2. **浮点型：`float`(4字节) \ `double`(8字节)**
   ...
   ⑤ `float`的有效位数大约为**6-7**位，`double`的有效位数大约为**15位**
...
3. **字符型：`char` (1字符=2字节)  2个`byte`大小**
   ...
   ③ **Unicoode转义序列会在解析代码之前得到处理**，例如"\u0022+\u0022"并不是一个由引号包围+构成的字符串，而是会解析成""+""从而得到一个空串
...
1. **自动类型提升：**
   ...
   ​	特别的：当`byte`、`char`、`short`三种类型的变量做运算时，结果为`int`型（同种类型做计算也需要`int`型接收）,也是会存在精度损失的，例如 long -> float
...
public class Test1 {
    public static void main(String[] args) {
        int i = -1; // -1 补码是全 1，无符号右移后变为 0111...1
        i = i >>> 1;
...
<img src="Java%E5%9F%BA%E7%A1%80.images/image-20220702110355938-170313062415537.png" alt="image-20220702110355938" style="zoom:80%;" />
...
2、数组**本身**是==引用数据类型==，但是数组的元素可以是基本数据类型和引用数据类型
...
<img src="Java%E5%9F%BA%E7%A1%80.images/image-20220713165037951-170313073836188.png" alt="image-20220713141625885" style="zoom:80%;" />
...
<img src="Java%E5%9F%BA%E7%A1%80.images/image-20220713100600008-170313074365291.png" alt="image-20220713165037951" style="zoom:50%;" />



**3. java.time.format.DateTimeFormatter(用来格式化)**

<img src="Java%E5%9F%BA%E7%A1%80.images/image-20220713165613090-170313074662594.png" alt="image-20220713165613090" style="zoom:50%;" />

**4. 其他API**

<img src="Java%E5%9F%BA%E7%A1%80.images/image-20220713170538129-170313074892597.png" alt="image-20220713170444754" style="zoom:50%;" />

<img src="Java%E5%9F%BA%E7%A1%80.images/image-20220713173442386-1703130752176100.png" alt="image-20220713170538129" style="zoom:50%;" />
...
- **String getProperty(String key)**：该方法的作用是获得系统中属性名为key的属性对应的值。系统中常见的属性名以及属性的作用如下表所示
  ...
  <img src="Java%E5%9F%BA%E7%A1%80.images/image-20220713173810910-1703130755818103.png" alt="image-20220713173442386" style="zoom:50%;" />
...
<img src="Java%E5%9F%BA%E7%A1%80.images/image-20220713182355705-1703130757938106.png" alt="image-20220713173810910" style="zoom:67%;" />
...
<img src="Java%E5%9F%BA%E7%A1%80.images/image-20220713174028981-1703130760224109.png" alt="image-20220713174028981" style="zoom:67%;" />
...
<img src="Java%E5%9F%BA%E7%A1%80.images/image-20220713170444754-1703130767061112.png" alt="image-20220713180923954" style="zoom:67%;" />
...
<img src="Java%E5%9F%BA%E7%A1%80.images/image-20220713182412615-1703130771001115.png" alt="image-20220713182355705" style="zoom:67%;" />

<img src="Java%E5%9F%BA%E7%A1%80.images/image-20220715180954868-1703130773213118.png" alt="image-20220713182412615" style="zoom:67%;" />
...
<img src="Java%E5%9F%BA%E7%A1%80.images/image-20220715105051665-1703130777422121.png" alt="image-20220715105051665" style="zoom:67%;" />
...
<img src="Java%E5%9F%BA%E7%A1%80.images/image-20220715114352655-1703130781935124.png" alt="image-20220715114352655" style="zoom:67%;" />
...
![image-20220715180954868](Java%E5%9F%BA%E7%A1%80.images/image-20220715195110687-1703130793778127.png)
...
<img src="Java%E5%9F%BA%E7%A1%80.images/image-20220716111003145-1703130798068130.png" alt="image-20220715195110687" style="zoom:67%;" />
...
![image-20220716111003145](Java%E5%9F%BA%E7%A1%80.images/image-20221030205111504-1703130804014133.png)
...
![image-20221030205111504](Java%E5%9F%BA%E7%A1%80.images/image-20220716170249418-1703130806189136.png)
...
<img src="Java%E5%9F%BA%E7%A1%80.images/image-20220716200858606-1703130813766139.png" alt="image-20220716170034429" style="zoom:70%;" />
...
<img src="Java%E5%9F%BA%E7%A1%80.images/image-20
![image-20220718152223683](Java%E5%9F%BA%E7%A1%80.images/image-20220718173912854-1703131418274223.png)
...
![image-20220718154737209](Java%E5%9F%BA%E7%A1%80.images/image-20220718162414391-1703131420208226.png)
...
![image-20220718162414391](Java%E5%9F%BA%E7%A1%80.images/image-20220718154737209-1703131423182229.png)
...
![image-20220718165723698](Java%E5%9F%BA%E7%A1%80.images/image-20220718165723698-1703131429899232.png)
...
![image-20220718173912854](Java%E5%9F%BA%E7%A1%80.images/image-20220718174305491-1703131438219235.png)

##### Optional加强

Optional 也增加了几个非常酷的方法，现在可以很方便的将一个 Optional 转换成一个 Stream, 或者当一个空 Optional 时给它一个替代的

![image-20220718174305491](Java%E5%9F%BA%E7%A1%80.images/image-20220718174934932-1703131441553238.png)
...
![image-20220718174934932](Java%E5%9F%BA%E7%A1%80.images/image-20220713180923954-1703131445225241.png)
...
public class Test
{
	...
	private void add(Integer i)
	{
		i = Integer.valueOf(i.intValue() - 1);  //这里实际上创建了一个新的Integer对象，所以造成了引用的改变，这个引用指向的不再是之前的那个对象了
	}
...
3. 如果T是Java中的任意类型或void关键字，T.class将代表匹配的类对象

### 利用反射分析类的能力

反射最重要的内容为----检查类的结构

`java.lang.reflect`中有三个**类**`Field、Method`和`Constructor`分别**描述类的字段、方法和构造器**。

- `getName`方法，用来返回字段、方法或构造器的名称
- `getType`方法，Field类中用来返回描述字段类型的一个对象，这个对象同样是Class
- Method和Constructor类有报告参数类型的方法
- Method还有报告返回类型的方法
- `getModifiers`，返回一个整数，用0/1位描述对应的修饰符（public、private、protected、static）

`Modifier`类也在`java.lang.reflect`中，通过静态方法`isPublic`、`isPrivate`、`isFinal`分析getModifiers方法返回整数。静态方法toString能够打印修饰符.

`Class`类中：

- `getFields`、`getMethods`、`getConstructors`方法分别返回类支持的**公共**字段、方法和构造器，其中包括超类的公共成员。
- `getDeclareFields`、`getDeclareMethods`、`getDeclareConstructors`分别返回类中声明的**全部**字段、方法和构造器，其中包括**私有**成员、包成员和受保护成员，但不包括超类成员

### 使用反射在运行时分析对象

**查看字段的具体内容**，关键方法是Field中的get方法

如果 f 是一个 Field 类型对象，obj 是某个包含 f 字段的类的对象，`f.get(obj)`返回 obj 当前字段 f 的值；`f.set(obj, value)` 可以设置值

若 f 是一个私有字段，则 get 和 set 方法会抛出`IllegalAccessException`。通过调用`AccessibleObject`类中的`setAccessible`方法能够覆盖 Java 的访问机制，它是 Field、Method和Constructor的公共超类。

### 调用方法和构造器

[上述内容](#使用反射在运行时分析对象)介绍了Field对象的使用，这里介绍Method和Constructor的使用。
...
第一个参数是隐式参数，其余的对象提供显式参数（如果为静态方法，第一个参数填null即可（当然某个对象实例也可以））

```java
Method m2 = Employee.class.getMethod("raiseSalary", double.class);  //获取Method对象
```

```jva
double s = m2.invoke(1.2);  //使用Method方法调用，确实很像C++函数指针
```
...
Object obj = cons.newInstance(42L);  //构造出了相应的Rnadom对象
```
...
- 解决默认方法冲突，如果一个接口中定义一个方法为默认方法，然后超类或另一个接口中定义了同样的方法，则
	...
	2. **接口冲突**。如果两个接口定义了同名且参数类型相同的方法，则必须覆盖这个方法来解决冲突
		...
		class Student implements Person, Named{
			public String getName(){
		        return Person.super.getName(); //可以选择其中一个方法也可以直接覆盖
		    }
		}
		```
...
`System.out::println`是一个[方法引用](#表.方法引用示例),它指示编译器生成一个函数式接口的实例。

要用`::`运算符分割方法名与对象或类名。主要有三种情况：

1. object::instanceMethod

	此时方法引用等价于向方法传递参数的lambda表达式。对于System.out::println，对象是System.out，所以方法表达式等价于x -> System.out.println(x)

2. Class::instanceMethod

	此时第一个参数会成为方法的隐式参数。例如String::compareToIgnoreCase 等同于 (x, y) -> x.conpareToIgnoreCase(y)
...
| Comsumer\<T>       | T        | void     | accept     | 处理一个T类型的值            | andThen                  |
...
<center id="常用函数式接口">常用函数式接口</center>
...
<div>			<!--块级封装-->
    <center>	<!--将图片和文字居中-->
    <img src="https://nrwflqzr.oss-cn-beijing.aliyuncs.com/typora-img/image-20230809221148067.png"
         alt="图片无法加载"
         style="zoom:这里写图片的缩放百分比"/>
    <br>		<!--换行-->
    Java中的异常层次结构	<!--标题-->
...
- Exception层次结构
	- RuntimeExcepton：由编程错误导致的异常属于RuntimeException
...
```java
throw new Exception();   //调用不同的构造器构造异常对象
//也可以如下抛出
var e = new Exception();
throw e;
```
...
假设资源属于一个实现了AutiCloseable接口的类，Java7为这种代码模式提供了一个很有用的跨界方式。AutoCloseable接口有一个方法（或者是Closeable接口，这是AutoCloseable的子接口，方法被声明为抛出一个IOException）：
...
**泛型类**就是有一个或多个类型变量的类，类型变量在整个类定义中用于指定方法的返回类型以及字段和局部变量的类型。

**泛型方法**就是一个带有类型参数的方法。类型变量放在修饰符的后面，返回类型的前面
...
**无论何时定义一个泛型类型，都会自动提供一个相应的原始类型**。原始类型的名字就是去掉类型参数后的泛型类型名。类型变量会被**擦除**，并替换为其限定类型（或Object）
...
```java
public static <T extend Comparable> min(T[] a)
...
如果试图查询一个对戏那个是否属于某个泛型类型，会得到一个编译器错误（instanceof）或者一个警告（强制类型转换，只能够知道 a 是一个 Pair，无法确定是否为 Pair\<String>）

`getClass`方法返回原始类型，因此
...
可变参数实际上也是数组，所以实际上虚拟机会建立一个Pair\<String>数组，违反了[不能创建参数化类型数组](#不能创建参数化类型的数组)这一规则。
...
- 传统的解决方案是通过反射调用Constructor.newInstance方法来构造泛型对象
	...
	```java
	T.class.getConstructor().newInstance(); //这种方式是错误的，始终要知道T会被擦除为Object
	//必须适当的设计API以便得到一个Class对象，例如
...
rawBuddies.setFirst(new File()); //会得到一个警告
```
...
<div>			<!--块级封装-->
    <center>	<!--将图片和文字居中-->
    <img src="https://nrwflqzr.oss-cn-beijing.aliyuncs.com/typora-img/image-20230814131408386.png"
         alt="图片无法加载"
         style="zoom:60%"/>
    <br>		<!--换行-->
    泛型列表类型中子类型间的关系	<!--标题-->
...
<div>			<!--块级封装-->
    <center>	<!--将图片和文字居中-->
    <img src="https://nrwflqzr.oss-cn-beijing.aliyuncs.com/typora-img/image-20230814210945595.png"
         alt="图片无法加载"
         style="zoom:100%"/>
    <br>		<!--换行-->
    集合框架的接口	<!--标题-->
...
<div>			<!--块级封装-->
    <center>	<!--将图片和文字居中-->
    <img src="https://nrwflqzr.oss-cn-beijing.aliyuncs.com/typora-img/集合框架中的类-导出.png"
         alt="图片无法加载"
         style="zoom:100%"/>
    <br>		<!--换行-->
    集合框架中的类	<!--标题-->
...
<center id="Java库中的具体集合">Java库中的具体集合</center>
...
- add方法用于向集合中添加元素。如果确实改变了集合返回true；没有改变集合返回false
- iterator方法用于返回一个实现了[Iterator](#Iterator迭代器)接口的对象，可以使用此对象一次访问集合中的元素
...
Set接口等同于[Collection](#Collection接口)接口，但是**Set的add方法不支持增加重复的元素**。
...
- for each 循环可以处理任何实现了[Iterable](#Iterable迭代器接口)接口的对象,[Collection](#Collection接口)接口扩展了[Iterable](#Iterable迭代器接口)接口，因此标准类库中的任何集合都可以使用 for each 循环
...
对于集合框架，实际上有两种有序集合：数组、链表，数组支持的有序集合能够快速地随机访问；链表尽管是有序的，但是随机访问很慢，更适合迭代器访问元素。所以如果原先提供两个接口可能会容易一些。

为了避免对链表完成随机访问操作，Java1.4引入了一个标记接口`RnadomAccess`，它不包含任何方法，只是用来标记一个特定的集合是否支持高效地随机访问
...
- LinkedList类的listIterator方法返回了一个实现了[ListIterator](#ListIterator)接口的迭代器对象
...
- TreeSet(Colletion<? extends E> elements)
...
1. 将执行这个任务的代码放在一个类的run方法中，这个类要实现`Runnable`接口

	```java
	public interface Runnable{
	    void run();
	}
	Runnable r = () -> {};  //可以使用lambda表达式
	```

2. 从这个Runnable构造一个`Thread`对象
...
用new操作符创建一个新线程时，new Thread(r)，这个线程还没有开始运行，此时的状态是[新建](#线程状态)

#### 可运行线程

调用start方法后，线程就处于[可运行](#线程状态)状态
...
<div>			<!--块级封装-->
    <center>	<!--将图片和文字居中-->
    <img src="https://nrwflqzr.oss-cn-beijing.aliyuncs.com/typora-img/线程状态-导出.png"
         alt="图片无法加载"
         style="zoom:60%"/>
    <br>		<!--换行-->
    线程状态	<!--标题-->
...
2. 静态的Stream.of方法
	...
	```java
	Stream<String> words = Stream.of(contents.split("\\PL+"));  //split返回一个String[]数组
	```

	of方法具有可变长参数，因此能够构建具有任意数量引元的流
...
5. Stream有两个接口用于创建无限流的静态方法
	...
	- 如果要产生像 0 1 2 3 ... 这样的序列，可以使用iterate方法
		...
		Stream<BigInteger?> integers = Strea,.iterate(BigInteger.ZERO, n->n.compareTo(limit)<0,n-> n.add(BigInteger.ONE));
		```
