...
![](MySQL数据库.images\image_20211020132711.jpg)
...
![image-20211013202511233](MySQL数据库.images\image-20211013202511233.png)
...
![image-20211013202815851](MySQL数据库.images\image-20211013202815851.png)
...
![image-20211013203029492](MySQL数据库.images\image-20211013203029492.png)
...
![image-20210730161043856](MySQL数据库.images\image-20210730161043856.png)
...
![image-20211020172958427](MySQL数据库.images\image-20211020172958427.png)
...
![image-20210914235534452](MySQL数据库.images\image-20210914235534452.png)
...
![image-20210914235610597](MySQL数据库.images\image-20210914235610597.png)
...
![image-20210914235651997](MySQL数据库.images\image-20210914235651997.png)
...
![image-20211014153722683](MySQL数据库.images\image-20211014153722683.png)
...
<img src="MySQL数据库.images\image-20211014154006530.png" alt="image-20211014154006530" style="zoom:90%;" />
...
![1575694476072](MySQL数据库.images\1575694476072.png)
...
**3. 点击 MySQL Community Server**
 ...
 <img src="MySQL数据库.images\image-20210817185955123.png" alt="image-20210817185955123" style="zoom:80%;" />
...
- 这里在Windows 系统下推荐下载`MSI安装程序`；点击`Go to Download Page`进行下载即可
 ...
 ![image-20211014163001964](MySQL数据库.images\image-20211014163001964.png)
...
![image-20211014163353156](MySQL数据库.images\image-20211014163353156.png)
...
<img src="MySQL数据库.images\image-20211014170638699.png" alt="image-20211014170638699" style="zoom:80%;" />

此时如果直接“Next”（下一步），则产品的安装路径是默认的。如果想要自定义安装目录，则可以选中对应的产品，然后在下面会出现“Advanced Options”（高级选项）的超链接。

<img src="MySQL数据库.images\image-20211014170814386.png" alt="image-20211014170814386" style="zoom:80%;" />
...
<img src="MySQL数据库.images\clip_image004-1634203188595.jpg" alt="img" style="zoom:80%;" />

其中，“Config Type”选项用于设置服务器的类型。单击该选项右侧的下三角按钮，即可查看3个选项，如图所示。

<img src="MySQL数据库.images\clip_image006-1634203188595.jpg" alt="img" style="zoom:80%;" />
...
<img src="MySQL数据库.images\clip_image008-1634203188595.jpg" alt="img" style="zoom:80%;" />
...
<img src="MySQL数据库.images\clip_image010-1634203188595.jpg" alt="img" style="zoom:80%;" />
...
<img src="MySQL数据库.images\clip_image012-1634203188596.jpg" alt="img" style="zoom:80%;" />

步骤6：单击“Next”（下一步）按钮，打开确认设置服务器窗口，单击“Execute”（执行）按钮。

<img src="MySQL数据库.images\clip_image014-1634203188596.jpg" alt="img" style="zoom:80%;" />

步骤7：完成配置，如图所示。单击“Finish”（完成）按钮，即可完成服务器的配置。

<img src="MySQL数据库.images\clip_image016.jpg" alt="img" style="zoom:80%;" />

步骤8：如果还有其他产品需要配置，可以选择其他产品，然后继续配置。如果没有，直接选择“Next”（下一步），直接完成整个安装和配置过程。

<img src="MySQL数据库.images\clip_image018.jpg" alt="img" style="zoom:80%;" />

步骤9：结束安装和配置。

<img src="MySQL数据库.images\clip_image020.jpg" alt="img" style="zoom:80%;" />
...
<img src="MySQL数据库.images\clip_image004.gif" alt="img" style="zoom:75%;" />

<img src="MySQL数据库.images\clip_image006.gif" alt="img" style="zoom:75%;" />
...
<img src="MySQL数据库.images\image-20211014185035137.png" alt="image-20211014185035137" style="zoom:80%;" />
...
<img src="MySQL数据库.images\MySQL编码2.jpg" style="zoom:90%;" />
...
![image-20211007153522427](MySQL数据库.images\image-20211007153522427.png)

左下角有个本地连接，点击，录入 Root 的密码，登录本地 MySQL 数据库服务器，如下图所示：

<img src="MySQL数据库.images\image-20211014195108502.png" alt="image-20211014195108502" style="zoom:80%;" />

<img src="MySQL数据库.images\image-20211014195129219.png" alt="image-20211014195129219" style="zoom:80%;" />
...
<img src="MySQL数据库.images\image-20211014213036470.png" alt="image-20211014213036470" style="zoom:80%;" />
...
<img src="MySQL数据库.images\image-20211014195237457.png" alt="image-20211014195237457" style="zoom:80%;" />

<img src="MySQL数据库.images\image-20211014195251371.png" alt="image-20211014195251371" style="zoom:75%;" />

<img src="MySQL数据库.images\image-20211014195300510.png" alt="image-20211014195300510" style="zoom:80%;" />
...
<img src="MySQL数据库.images\image-20211019215408965.png" alt="image-20211019215408965" style="zoom:80%;" />
...
![image-20211007154113052](MySQL数据库.images\image-20211007154113052.png)
...
<img src="MySQL数据库.images\image-20211014230114639.png" alt="image-20211014230114639" style="zoom:80%;" />
...
![1554951801044](MySQL数据库.images\1554951801044.png)
...
![image-20211012104955094](MySQL数据库.images\image-20211012104955094.png)
...
![image-20211012105030527](MySQL数据库.images\image-20211012105030527.png)
...
![image-20211012110241418](MySQL数据库.images\image-20211012110241418.png)
...
![image-20211012110511223](MySQL数据库.images\image-20211012110511223.png)
...
<img src="MySQL数据库.images\image-20211023115738415.png" alt="image-20211023115738415" style="zoom:80%;" />
...
![image-20211012111042395](MySQL数据库.images\image-20211012111042395.png)

![image-20211012110731059](MySQL数据库.images\image-20211012110731059.png)
...
![image-20210926151249943](MySQL数据库.images\image-20210926151249943.png)
...
![1554974260133](MySQL数据库.images\1554974260133.png)
...
![1554974827522](MySQL数据库.images\1554974827522.png)
...
```
 ...
 ![1554974853194](MySQL数据库.images\1554974853194.png)

![1554974858252](MySQL数据库.images\1554974858252.png)
...
![1554974901572](MySQL数据库.images\1554974901572.png)

![1554974907498](MySQL数据库.images\1554974907498.png)
...
![1554974984600](MySQL数据库.images\1554974984600.png)

从多个表中获取数据：

![1554975020388](MySQL数据库.images\1554975020388.png)
...
![1554975097631](MySQL数据库.images\1554975097631.png)
...
![1554975496900](MySQL数据库.images\1554975496900.png)
...
![1554975522600](MySQL数据库.images\1554975522600.png)

![1554975526339](MySQL数据库.images\1554975526339.png)

**拓展1：多个连接条件与 AND 操作符** 

![1554975606231](MySQL数据库.images\1554975606231.png)
...
![1554978354431](MySQL数据库.images\1554978354431.png)
...
![1554978442447](MySQL数据库.images\1554978442447.png)
...
![1554978477013](MySQL数据库.images\1554978477013.png)

![1554978482652](MySQL数据库.images\1554978482652.png)

####  分类2：自连接 vs 非自连接

![1554978514321](MySQL数据库.images\1554978514321.png)
...
![1554978684947](MySQL数据库.images\1554978684947.png)

![1554978690764](MySQL数据库.images\1554978690764.png)
...
![1554978955659](MySQL数据库.images\1554978955659.png)
...
![1554979073996](MySQL数据库.images\1554979073996.png)

![1554979079395](MySQL数据库.images\1554979079395.png)
...
![1554979110008](MySQL数据库.images\1554979110008.png)

![1554979115642](MySQL数据库.images\1554979115642.png)
...
![1554979200961](MySQL数据库.images\1554979200961.png)
...
![1554979243194](MySQL数据库.images\1554979243194.png)
...
<img src="MySQL数据库.images\1554979317187.png" alt="1554979317187" style="zoom: 67%;" />

UNION 操作符返回两个查询的结果集的并集，去除重复记录。

**UNION ALL操作符**

<img src="MySQL数据库.images\1554979343634.png" alt="1554979343634" style="zoom: 67%;" />
...
<img src="MySQL数据库.images\1554979255233.png" alt="1554979255233" style="zoom:80%;" />
...
![1554979529525](MySQL数据库.images\1554979529525.png)
...
![1555433204337](MySQL数据库.images\1555433204337.png)
...
![image-20211025162304844](MySQL数据库.images\image-20211025162304844.png)
...
![image-20211025162538958](MySQL数据库.images\image-20211025162538958.png)
...
![image-20211025162730421](MySQL数据库.images\image-20211025162730421.png)
...
![image-20211025163846974](MySQL数据库.images\image-20211025163846974.png)
...
![image-20211025213504115](MySQL数据库.images\image-20211025213504115.png)
...
![image-20211012142639469](MySQL数据库.images\image-20211012142639469.png)

![image-20211012142746444](MySQL数据库.images\image-20211012142746444.png)
...
![image-20211012143203355](MySQL数据库.images\image-20211012143203355.png)
...
![image-20211012145231321](MySQL数据库.images\image-20211012145231321.png)
...
![1554980865631](MySQL数据库.images\1554980865631.png)
...
![1554980924940](MySQL数据库.images\1554980924940.png)
...
![1554981029920](MySQL数据库.images\1554981029920.png)
...
![1554981279723](MySQL数据库.images\1554981279723.png)
...
![1554981253194](MySQL数据库.images\1554981253194.png)
...
![1554981241299](MySQL数据库.images\1554981241299.png)
...
![1554981328678](MySQL数据库.images\1554981328678.png)
...
![1554981374920](MySQL数据库.images\1554981374920.png)
...
![1554981539408](MySQL数据库.images\1554981539408.png)

![1554981544191](MySQL数据库.images\1554981544191.png)
...
![1554981574152](MySQL数据库.images\1554981574152.png)

 2.2 使用多个列分组

![1554981607442](MySQL数据库.images\1554981607442.png)
...
![1554981624864](MySQL数据库.images\1554981624864.png)

![1554981629733](MySQL数据库.images\1554981629733.png)
...
![1554981656798](MySQL数据库.images\1554981656798.png)
...
![1554981808091](MySQL数据库.images\1554981808091.png)
...
![1554981824564](MySQL数据库.images\1554981824564.png)
...
```
 ...
 ![1554981724375](MySQL数据库.images\1554981724375.png)
...
![1566872301088](MySQL数据库.images\1566872301088.png)
...
<img src="MySQL数据库.images\1554991034688.png" alt="1554991034688" style="zoom:80%;" />
...
![1554991316599](MySQL数据库.images\1554991316599.png)

####  1.2 子查询的基本使用

- 子查询的基本语法结构：

 ![1554991054388](MySQL数据库.images\1554991054388.png)
...
- 单行子查询（只查询出一个结果）
  ...
  ![1554991538719](MySQL数据库.images\1554991538719.png)

- 多行子查询（查询出多个结果）

![1554991555669](MySQL数据库.images\1554991555669.png)
...
**题目：查询工资大于149号员工工资的员工的信息**
 ...
 ![image-20210914232952626](MySQL数据库.images\image-20210914232952626.png)

 ![image-20210914232935062](MySQL数据库.images\image-20210914232935062.png)
...
![1554991892770](MySQL数据库.images\1554991892770.png)
...
![1554991935186](MySQL数据库.images\1554991935186.png)
...
![1554992067381](MySQL数据库.images\1554992067381.png)
...
![1554992135819](MySQL数据库.images\1554992135819.png)

> **多行子查询使用单行比较符**  这里的=是单行操作符

### 3. 多行子查询

- 也称为集合比较子查询
- 内查询返回多行（与多列不同，多列可以成对比较）
- 使用多行比较操作符
...
![1554992658876](MySQL数据库.images\1554992658876.png)

![1554992664594](MySQL数据库.images\1554992664594.png)

![1554992668429](MySQL数据库.images\1554992668429.png)

**题目：返回其它job_id中比job_id为‘IT_PROG’部门所有工资都低的员工的员工号、姓名、job_id以及salary**

![1554992753654](MySQL数据库.images\1554992753654.png)

![1554992759467](MySQL数据库.images\1554992759467.png)
...
```
 ...
 ![image-20211027195906773](MySQL数据库.images\image-20211027195906773.png)
...
<img src="MySQL数据库.images\1554992898234.png" alt="1554992898234" style="zoom:80%;" />

<img src="MySQL数据库.images\1554992925281.png" alt="1554992925281" style="zoom:80%;" />
...
![1554992986225](MySQL数据库.images\1554992986225.png)
...
![1554993169269](MySQL数据库.images\1554993169269.png)
...
![image-20211007155810920](MySQL数据库.images\image-20211007155810920.png)
...
```
 ...
 ![image-20211016160557995](MySQL数据库.images\image-20211016160557995.png)
...
![image-20211016160643445](MySQL数据库.images\image-20211016160643445.png)
...
- 使用 AS subquery 选项，**将创建表和插入数据结合起来**
  ...
  ![1554997882872](MySQL数据库.images\1554997882872.png)
...
```
 ...
 ![1554997998148](MySQL数据库.images\1554997998148.png)

 ![1554998004494](MySQL数据库.images\1554998004494.png)
...
![1554998139815](MySQL数据库.images\1554998139815.png)
...
- 【参考】合适的字符存储长度，不但节约数据库表空间、节约索引存储，更重要的是提升检索速度。 
  ...
  ![image-20211024012735469](MySQL数据库.images\image-20211024012735469.png)
...
<img src="MySQL数据库.images\1555425366064.png" alt="1555425366064" style="zoom:80%;" />
...
![1555425824246](MySQL数据库.images\1555425824246.png)
...
![1555426124751](MySQL数据库.images\1555426124751.png)

- 使用 DELETE 语句从表中删除数据

![1555426162264](MySQL数据库.images\1555426162264.png)
...
```
 ...
 ![1555426258516](MySQL数据库.images\1555426258516.png)
...
![image-20211007173312237](MySQL数据库.images\image-20211007173312237.png)
...
- MySQL允许使用`非标准语法`（其他数据库未必支持，因此如果涉及到数据迁移，则最好不要这么用）：`FLOAT(M,D)`或`DOUBLE(M,D)`。这里，M称为`精度`，D称为`标度`。(M,D)中 M=整数位+小数位，D=小数位。 D<=M<=255，0<=D<=30。存在四舍五入
...
![image-20211012003508730](MySQL数据库.images\image-20211012003508730.png)
...
在向TEXT类型的字段保存和查询数据时，系统自动按照实际长度存储，不需要0预先定义长度。这一点和 VARCHAR类型相同。
...
![image-20211104192516324](MySQL数据库.images\image-20211104192516324.png)
...
![image-20211104192912988](MySQL数据库.images\image-20211104192912988.png)

- MultiPoint、MultiLineString、MultiPolygon、GeometryCollection 这4种类型都是集合类，是多个Point、LineString或Polygon组合而成。

下面展示的是多个同类或异类几何图形元素的组合：

![image-20211104193330204](MySQL数据库.images\image-20211104193330204.png)
...
![1555426972098](MySQL数据库.images\1555426972098.png)
...
用来限制某个字段/某列的值不能重复。
 ...
 ![1555427198811](MySQL数据库.images\1555427198811.png)
...
![1555427492244](MySQL数据库.images\1555427492244.png)
...
![1555428214706](MySQL数据库.images\1555428214706.png)
...
![1555430281798](MySQL数据库.images\1555430281798.png)
...
- **视图建立在已有表的基础上**, 视图赖以建立的这些表称为**基表**。
  ...
  <img src="MySQL数据库.images\image-20211006211206990.png" alt="image-20211006211206990" style="zoom:67%;" />
...
<img src="MySQL数据库.images\1555430882363.png" alt="1555430882363" style="zoom:80%;" />
...
![image-20211010211744459](MySQL数据库.images\image-20211010211744459.png)
...
![image-20211108114846634](MySQL数据库.images\image-20211108114846634.png)
...
```
 ...
 ![image-20211111182656990](MySQL数据库.images\image-20211111182656990.png)
...
假设我们用`进货单头表`（demo.importhead）来保存进货单的总体信息，包括进货单编号、供货商编号、仓库编号、总计进货数量、总计进货金额和验收日期。
 ...
 ![image-20211010233336012](MySQL数据库.images\image-20211010233336012.png)

用`进货单明细表`（demo.importdetails）来保存进货商品的明细，包括进货单编号、商品编号、进货数量、进货价格和进货金额。

 ![image-20211010233344125](MySQL数据库.images\image-20211010233344125.png)
...
![image-20210730165317542](MySQL数据库.images\image-20210730165317542.png)
...
MySQL官方网站窗口函数的网址为https://dev.mysql.com/doc/refman/8.0/en/window-function-descriptions.htmlfunction_row-number。

窗口函数总体上可以分为序号函数、分布函数、前后函数、首尾函数和其他函数，如下表：

![image-20211012162944536](MySQL数据库.images\image-20211012162944536.png)
